...
- Trying to find a way to scan barcodes
	- We found an library "html5-qrcode" that scans barcodes.
- library provided only barcode and no information
	- We found another API that can tell you information based on barcodes.
- Whether or not to include a database for accounts
	- We decided to start with no database, but ended up developing it in the end.
...
## Credits
- Municipal rules look up for recycling: https://serpapi.com/
